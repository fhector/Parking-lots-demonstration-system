...
#define OS_MAX_EVENTS            1000    /* Max. number of event control blocks in your application      */
#define OS_MAX_FLAGS              500    /* Max. number of Event Flag Groups    in your application      */
#define OS_MAX_MEM_PART           500    /* Max. number of memory partitions                             */
#define OS_MAX_QS                 20    /* Max. number of queue control blocks in your application      */
#define OS_MAX_TASKS             60    /* Max. number of tasks in your application, MUST be >= 2       */
