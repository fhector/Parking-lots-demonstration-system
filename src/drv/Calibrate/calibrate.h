...
EXTERN int setCalibrationMatrix( calibrate_POINT * display,
                                 calibrate_POINT * screen,
                                 calibrate_MATRIX * matrix) ;


EXTERN int getDisplayPoint( calibrate_POINT * display,
                            calibrate_POINT * screen,
                            calibrate_MATRIX * matrix ) ;
